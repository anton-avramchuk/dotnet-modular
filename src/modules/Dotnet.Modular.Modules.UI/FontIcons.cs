...
{
    /// <summary>
    /// Defines framework-agnostic icon names that can be mapped to specific UI framework icons (Material, Bootstrap, etc.)
    /// </summary>
    public static class FontIcons
    {
        ...
        public const string ExpandMore = "ExpandMore";
        public const string ExpandLess = "ExpandLess";
